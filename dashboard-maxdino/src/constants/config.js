// export const HOST = "http:localhost/an.thoi.maxdino.backend/public/api";
...
export const HOST = "http://localhost:800/maxdino.final/maxdino_backend/public/api";
export const IMAGE_LINK = "https://maxdino.koreacentral.cloudapp.azure.com/";
